...
echo "=================================================="
echo "RUNNING: p11 no-PDZ hellcamp outer"
echo "TIME: $(date)"
echo "=================================================="
...
"${PYTHON_BIN}" main.py \
  ...
  --outer_source_weights "ATLAS=2,PDBbind v2020=1,SAbDab=2,SKEMPI v2.0=1,PDZ_PBM=0" \
  --seed 43 \
  --random_seed 43 \
  --output_dir experiments/p11_outer_no_pdz_hellcamp_seed43
